...
public class HospitalDto {
    ...
    private String hospitalUrl; //병원 홈페이지
    ...
    @Builder
    public HospitalDto(String code, String name, String address, String phoneNumber, String hospitalUrl, String postNumber, String typeName, String stateName, String cityName, String emdongName, String xPos, String yPos) {
        this.code = code;
        this.name = name;
