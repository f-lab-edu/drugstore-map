...
@Component
@Slf4j
public class TimePatternMatcher5 implements PatternMatcherInterface {
    private final Pattern timePattern = Pattern.compile("(오전|오후|아침)?(\\d{1,2})시(\\d{2}분)?부터(접수)?");         //09시30분부터
